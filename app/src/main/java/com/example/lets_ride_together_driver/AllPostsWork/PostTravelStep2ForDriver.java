...
public class PostTravelStep2ForDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehicletypeSpinner = findViewById(R.id.vehicletype_spinner);
        fareAmountEt = findViewById(R.id.fareAmountEt);
        offermessage = findViewById(R.id.message_detailsTx);
        noOfPassenger = findViewById(R.id.no_of_passengersEdtx);
