...
public class PostYourTravel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        offerLiftLayout = findViewById(R.id.offer_lift_layout);
        routeArrow = findViewById(R.id.route_arrow);
        startPointLayout = findViewById(R.id.start_point_layout);
        startPointTx = findViewById(R.id.startPointTx);
        offerLiftStartName = findViewById(R.id.offer_lift_start_name);
        offerLiftStartAddress = findViewById(R.id.offer_lift_start_address);
        endPointLayout = findViewById(R.id.end_point_layout);
        endPointTx = findViewById(R.id.endPointTx);
        offerLiftEndName = findViewById(R.id.offer_lift_end_name);
        offerLiftEndAddress = findViewById(R.id.offer_lift_end_address);
        daysLayout = findViewById(R.id.days_layout);
        regularTripsw = findViewById(R.id.regularTripsw);
        offerRoundTripSw = findViewById(R.id.offerRoundTripSw);
        offerdaysLayout = findViewById(R.id.offerdaysLayout);
        ...
        offerdeparturedate = findViewById(R.id.offerdeparturedate);
        offerdeparturedateHeader = findViewById(R.id.offerdeparturedate_header);
        offerdeparturedateDetail = findViewById(R.id.offerdeparturedate_detail);
        ...
        offerReturnTimetx = findViewById(R.id.offerReturnTimetx);
        offerreturndateHeader = findViewById(R.id.offerreturndate_header);
        offerreturndateDetail = findViewById(R.id.offerreturndate_detail);
    ...
    public void toggleClickListners() {
        ...
        findViewById(R.id.offerLiftConfirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String profileimgurl = prefs.getString("imageUri", "noimg");
                String fullname = prefs.getString("name", "noname");
                String vehtype = prefs.getString("car_type", "novtype");
                String phoneno = prefs.getString("phone", "nophone");
