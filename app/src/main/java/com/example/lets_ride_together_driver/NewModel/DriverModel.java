...
public class DriverModel {
    ...
    public DriverModel(String uid, String email, String status, String reported, String fullname, String cnicno,
                       String phoneno, String provence, String city, String designetion, String age, String vehicalname,
                       String vehicalnoplate, String verified, String currentlogitude, String currentlatitude,
                       String profileimageurl, String gender, String vehicaltype, String online, String locationsharing) {
        this.uid = uid;
        this.email = email;
        this.status = status;
        ...
        this.vehicalnoplate = vehicalnoplate;
    ...
    public String getVehicalnoplate() {
        return vehicalnoplate;
    }

    public void setVehicalnoplate(String vehicalnoplate) {
        this.vehicalnoplate = vehicalnoplate;
    }
