...
import com.example.lets_ride_together_driver.Adapter.PassengerPostsAdapter;
...
public class CarpoolHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference ref = mdata.getReference(Common.user_driver_tbl).child(FirebaseAuth.getInstance().getUid());
