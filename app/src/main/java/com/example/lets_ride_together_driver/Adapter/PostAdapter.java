...
import com.example.lets_ride_together_driver.AllPostsWork.ScreenAfterPostIsSelectedFromList;
...
import com.example.lets_ride_together_driver.ProfilePageStuff.RecivedRequestsActivity;
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                switch (item.getTitle().toString()) {
                                    case "Accept Request":
                                        ...
                                        SharedPreferences prefs = context.getSharedPreferences(Common.MY_SHARED_PREF_NAME, MODE_PRIVATE);
                                        ...
                                        DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("Driver Accepted Requests").child(uid2).child(obj.getPhoneno()).push();
...
//                                });
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            nametxt = view.findViewById(R.id.name_rec_post);
